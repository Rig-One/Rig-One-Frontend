        ...
        >
          <div className="flex justify-end">
            <button
              ...
              aria-label="Close end shift modal"
            >
              <CloseIcon />
            </button>
          </div>
          ...
          <div className="-mt-2 text-center">
            <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-[#FEE4E2] text-[#F04438]">
              <StopIcon />
            </div>
            <h2 className="mt-4 text-[28px] font-semibold text-[#053361]">End Shift</h2>
